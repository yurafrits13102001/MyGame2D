...
//        i++;
        ...
        gamePanel.obj[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.obj[i] = new OBJ_CherryJuice(gamePanel);
    ...
    public void setMonster(){
        ...
        gamePanel.monster[7] = new MON_GreenSlime(gamePanel);
        gamePanel.monster[7].worldX = 23 * gamePanel.tileSize;
        gamePanel.monster[7].worldY = 45 * gamePanel.tileSize;
    }
    ...
    public void setInteractive(){
        ...
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 11 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 12 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 13 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 14 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 15 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 16 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 17 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 18 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 19 * gamePanel.tileSize;
        ...
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 11 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 30 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 12 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 30 * gamePanel.tileSize;
        ...
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 24 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 30 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 25 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 30 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 26 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 30 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 27 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 30 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 28 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 30 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 20 * gamePanel.tileSize;
        ...
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 29 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 30 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 31 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 32 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 33 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 34 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 35 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 29 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 29 * gamePanel.tileSize;
        ...
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 26 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 28 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 27 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 28 * gamePanel.tileSize;
        ...
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 36 * gamePanel.tileSize;
        gamePanel.iTile[i].worldY = 28 * gamePanel.tileSize;
        i++;
        gamePanel.iTile[i] = new IT_Grass(gamePanel);
        gamePanel.iTile[i].worldX = 25 * gamePanel.tileSize;
